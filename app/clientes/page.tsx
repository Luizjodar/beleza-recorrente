...
export default function ClientesAnalise() {
  ...
  const sessentaDiasAtras = new Date(hoje); sessentaDiasAtras.setDate(hoje.getDate() - 60)
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '36px 24px' }}>
        ...
        <div style={{ background: t.bgCard, border: `0.5px solid ${t.borderCard}`, borderRadius: 18, overflow: 'hidden' }}>
          ...
          {filtrados.length === 0 ? (
            ...
            const statusBg: any = { ativo: t.badgeAtivo, inadimplente: t.badgeInadimplente, cancelado: t.badgeCancelado, pausado: t.badgePausado }
            const statusTx: any = { ativo: t.badgeAtivoText, inadimplente: t.badgeInadimplenteText, cancelado: t.badgeCanceladoText, pausado: t.badgePausadoText }
            return (
