...
export default function ConfiguracoesPage() {
  ...
  async function salvar() {
    ...
    if (slug !== slugOriginal) {
      ...
      if (existente) {
        setErro('Este link público já está sendo usado. Escolha outro.')
        return
      }
    }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-400 mt-1">Informações exibidas na sua página pública de assinatura</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
          ...
          <div className="px-6 py-5 border-b border-gray-100">
            ...
            <div>
              ...
              <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden focus-within:border-emerald-400 transition-colors">
              ...
              <p className="text-xs text-gray-400 mt-1.5">
                Só letras minúsculas, números e hífens. Este é o link que você compartilha com seus clientes.
              </p>
            </div>
          ...
          <div className="px-6 py-5 border-b border-gray-100">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden focus-within:border-emerald-400 transition-colors">
                  <span className="bg-gray-50 px-3 py-2 text-sm text-gray-400 border-r border-gray-200">
                    +
                  </span>
                  <input
                    value={whatsapp}
                ...
                <p className="text-xs text-gray-400 mt-1.5">
                  Código do país + DDD + número, sem espaços. Ex: 5519999999999
                </p>
              </div>
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-400 mt-1.5">
                  Você receberá um email aqui sempre que alguém assinar um plano.
                </p>
              </div>
