            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {promocoes.map(p => (
                <div key={p.id} style={{ background: 'white', border: '1px solid #e8e8e8', borderRadius: 16, overflow: 'hidden', position: 'relative' }}>
                  {p.imagem_url && (
                    <img src={p.imagem_url} alt={p.titulo} style={{ width: '100%', maxHeight: 400, objectFit: 'contain', background: '#f5f5f5', display: 'block', borderRadius: '16px 16px 0 0' }} />
                  )}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {pacotes.map((p, idx) => (
              <div key={p.id}
                ...
                {p.imagem_url && (
                  <img src={p.imagem_url} alt={p.nome} style={{ width: '100%', maxHeight: 400, objectFit: 'contain', background: '#f5f5f5', display: 'block', borderRadius: '16px 16px 0 0' }} />
                )}
